...
var _default = {
  ...
  methods: {
    ...
    fetchEntry: function fetchEntry() {
      var self = this;
      return _axios.default.get(this.apiEntryChart).then(function (response) {
        // handle success
        ...
        self.$toast.open({
          duration: 5000,
          message: "Mohon Maaf, Kami tidak dapat menghubungi server terkait data entry.",
          position: "is-top",
          type: "is-danger"
        });
      });
  ...
  mounted: function mounted() {
    if (this.apiEntryChart !== undefined) {
      var self = this;
