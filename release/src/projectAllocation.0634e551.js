...
var _default = {
  ...
  methods: {
    ...
    fetchLevel: function fetchLevel(role) {
      ...
      return _axios.default.get("http://localhost:5501/demo/level_api.php?role=" + role).then(function (response) {
        // handle success
