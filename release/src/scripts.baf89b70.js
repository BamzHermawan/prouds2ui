...
},{"./lib/axios":"HXpE"}],"VsMw":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    ...
    fetchdataChart: function fetchdataChart() {
      var self = this;
      return _axios.default.get(this.dataBae).then(function (response) {
        // handle success
  ...
  mounted: function mounted() {
    console.log(_typeof(this.dataBae));
...
},{"highcharts":"Dm41","axios":"uj17"}],"X5NK":[function(require,module,exports) {
var global = arguments[3];
var process = require("process");
